...
The design assumes that there are common elements (e.g., fitness functions, selection schemes, populations, etc.) in 
many evolutionary computation (EC) research projects. Leveraging these similarities allows for the efficient reuse of common 
