...
namespace mabe {
  ...
  public:
    ...
    void SetupFuncs(){
      ...
      action_map.AddFunc<void, VirtualCPUOrg&, const VirtualCPUOrg::inst_t&>("IfNEqu",func_if_n_equ);
      // If less 
      ...
      action_map.AddFunc<void, VirtualCPUOrg&, const VirtualCPUOrg::inst_t&>("IfLess", func_if_less);
      // If label 
      ...
      action_map.AddFunc<void, VirtualCPUOrg&,const VirtualCPUOrg::inst_t&>("IfLabel",func_if_label);
    }
