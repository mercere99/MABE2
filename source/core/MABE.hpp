...
namespace mabe {
  ...
  protected:
    ...
    /// Controller that handles all custom signals and actions
    emp::SignalControl custom_sig_control; 
  ...
  public:
    ...
    /// Allow access to MABE objects SignalControl instance to allow custom signals and actions 
    emp::SignalControl & GetSignalControl(){
      return custom_sig_control;
    }
  };
