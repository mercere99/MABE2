...
namespace mabe {
  ...
  public:
    ...
    emp::String ToString() const override { return "[empty]"; }
  ...
  public:
    EmptyOrganismManager(MABE & in_control, const emp::String & in_name, const emp::String & in_desc="")
      : OrganismManager<EmptyOrganism>(in_control, in_name, in_desc) { ; }
    ~EmptyOrganismManager() { ; }

    emp::String GetTypeName() const override { return "EmptyOrganismManager"; }
