 ...
 *
 *  DEPRICATED!  This functionality has been rolled into ModuleBase
 * 
 *  The main MABE controller will manipulate organism managers through this base class.
 *  Note that the derived OrganismManager objects store a reference to the MABE controller and
 *  can manipulate it.
 * 
 */
